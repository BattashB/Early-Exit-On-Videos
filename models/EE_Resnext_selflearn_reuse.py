...
from .exit_blocks_reuse import EarlyExitBlockA,EarlyExitBlockB, EarlyExitBlockBS,EarlyExitBlockBS_LR_E2,EarlyExitBlockBS_LR_E1
...
class ResNextEE(nn.Module):
    ...
    def forward(self, x):
        ...
        #"""
        if self.exit2_bool:
            exit2 = self.exit2(x,exit1[0],exit1[1])
            output.append(exit2)
