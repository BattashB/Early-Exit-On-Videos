...
class UCFclassification(object):
    ...
    def __init__(self, ground_truth_filename=None, prediction_filename=None,
        ...
        print("entered to UCFclassification")
    ...
    def evaluate(self):
        ...
        if self.verbose:
            print ('[RESULTS] Performance on ActivityNet untrimmed video '
                   'classification task.')
            print('\tTop@{}: {}'.format(self.top_k, hit_at_k))
...
if __name__ == "__main__":
    ucf = UCFclassification('/workspace/VideoRecognition_v1/ucfannotation/ucf101_03.json', 'results/val1.json',verbose=True, top_k=1) 
    ucf.evaluate() 