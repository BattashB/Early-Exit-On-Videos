...
if __name__ == "__main__":
    hmdb = KINETICSclassification('/workspace/Early-Exit-In-Videos/kinetics_annotation.json','/workspace/Early-Exit-In-Videos/results/val_kinetics_resnext101.json',verbose=True, top_k=1) 
    hmdb.evaluate() 
