    ...
    def _import_prediction(self, prediction_filename):
        ...
        for videoid, v in data['results'].items():
            ...
            for result in v:
                ...
                video_lst.append(videoid.split('/')[1])
...
if __name__ == "__main__":
    hmdb = KINETICSclassification('/workspace/Early-Exit-In-Videos/results/val_kinetics_resnext101.json', '/workspace/Early-Exit-In-Videos/kinetics_annotation.json',verbose=True, top_k=1) 
    hmdb.evaluate() 
