...
################New arguments######################
#when training on kinetics this argument is the same as pretrain_path, when finetuning on hmdb51 we want the pretrain_path to be the 
#the model+ee trained on kinetics, and the loan_path to be model finetuned on hmdb51
    parser.add_argument(
        '--loan_fc_path',
        default='',
        type=str,
    ...
    parser.add_argument(
        '--finetune',
        action='store_true',
        help='If True, Finetuning is performed.')
...
###################################################
    ...
    parser.add_argument(
        '--annotation_path',
        default='annotation_dir_path/hmdb51/hmdb51_1.json',
        type=str,
    ...
    parser.add_argument(
        '--deformable', action='store_true', help='deformable')
    parser.set_defaults(deformable=False)
    parser.add_argument(
        '--n_finetune_classes',
        default=51,
        type=int,
    ...
    parser.add_argument(
        '--evaluate_clip_level',
        action='store_true',
        help='If true, will evaluate class level prediction,validation have to be on!.')
